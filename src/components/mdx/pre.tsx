...
export const MDX_Pre: React.FC<MDX_PreProps> = (props: MDX_PreProps) => {
    ...
    return (
        <div>
            <div
                className="border-t-2 border-l-2 border-r-2 border-gray-200 dark:border-gray-800 rounded-t-md py-2 px-4 text-gray-500 dark:text-gray-400 text-xs sm:text-sm font-mono flex flex-row justify-between items-center"
            >
                <div

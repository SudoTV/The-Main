...
> 注意，以上列表可能不完整。所有在 SudoTV 下过去，目前，以及未来发布的视频都受此政策的限制。我们保留更改范围的权利。

## 开源

所有在 SudoTV 下的视频都是开源的，因此您可以在遵守本站描述的视频转载政策的情况下转载。
...
所有 SudoTV 的视频都基于 [CC-BY-NC_ND 4.0 协议](http://creativecommons.org/licenses/by-nc-nd/4.0/) 开源。

## 权利和限制

根据 [CC-BY-NC_ND 4.0 协议](http://creativecommons.org/licenses/by-nc-nd/4.0/)，在与属于 SudoTV 的视频互动时，您受到以下内容提供的权利保护和使用限制。

### 您可以自由地

> 只要你遵守许可协议条款，SudoTV 就无法收回你的这些权利。

- 共享 — 在任何媒介以任何形式复制、发行 SudoTV （下称“我们”）的作品。
